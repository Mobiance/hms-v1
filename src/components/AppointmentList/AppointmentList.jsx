  ...
  return (
    <>
        ...
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          ...
          <TableBody>
            {appointments.map((row, index) => (
              <StyledTableRow key={row._id} onClick={() => {handleClick(row)}}>
                <StyledTableCell align="left">{index}</StyledTableCell>
                <StyledTableCell align="left">{row.patientName}</StyledTableCell>
                <StyledTableCell align="left">{row.patientGender}</StyledTableCell>
                <StyledTableCell align="left">{row.patientAge}</StyledTableCell>
                <StyledTableCell align="left">{row.patientMobileNumber}</StyledTableCell>
                <StyledTableCell align="left">{row.reason}</StyledTableCell>
                <StyledTableCell align="left">
                  <Fab color="" size="small" onClick={() => handleDelete(row._id)}>
      ...
      >
        ...
        >
        <h2 id="modal-title" style={{ color: '#008DDA' }}>Add New Appointment</h2>
        <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <MenuItem defaultChecked value="Male">Male</MenuItem>
